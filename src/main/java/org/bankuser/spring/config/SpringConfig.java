package org.bankuser.spring.config;
...
@Configuration
@ComponentScan("org.bankuser.spring")
@EnableWebMvc
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    public SpringResourceTemplateResolver templateResolver() {
        ...
        templateResolver.setPrefix("/WEB-INF/views/head/");
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] {"org.bankuser.spring.entity"
        });
